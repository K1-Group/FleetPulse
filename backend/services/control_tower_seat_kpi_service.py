...
CATALOG: tuple[SeatKpiContract, ...] = (
    ...
    SeatKpiContract(
        ...
        base_status=ControlTowerStatus.WARNING,
        required_config=("FLEETPULSE_XCELERATOR_EVENT_FEED_URL|FLEETPULSE_XCELERATOR_EVENT_STATE_PATH",),
    ...
    SeatKpiContract(
        ...
        base_status=ControlTowerStatus.WARNING,
        required_config=("FLEETPULSE_QBO_FINANCIAL_FEED_URL|FLEETPULSE_QBO_FINANCIAL_FEED_PATH|FLEETPULSE_QBO_FINANCIAL_STATE_PATH",),
    ...
    SeatKpiContract(
        ...
        seat_id="people_systems_manager",
        target="5 hires/week; 10 qualified applicants; 95% first touch <=24h; 0 untouched >48h; 50% orientation show rate",
        ...
        owner_action="Schedule approved HR snapshot import with qualified, first-touch, stale, and orientation evidence.",
    ),
    SeatKpiContract(
