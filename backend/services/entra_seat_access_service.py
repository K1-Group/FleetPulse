...
DEFAULT_SEAT_DEFINITIONS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "tabs": ["dashboard", "operating-system", "employee-workforce", "hr-recruiting", "reports"],
    },
]
...
PATH_TAB_PREFIXES = [
    ...
    ("/api/trips", "replay"),
    ("/api/address-benchmarks", "address-benchmarks"),
    ("/api/reports", "reports"),
    ("/api/geofences", "geofences"),
    ("/api/compliance", "compliance"),
    ("/api/data-connector", "data-connector"),
    ("/api/employee-workforce", "employee-workforce"),
    ("/api/driver-workforce", "control-tower"),
    ("/api/driver-compliance", "driver-compliance"),
