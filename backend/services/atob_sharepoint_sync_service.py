...
ATOB_POWER_AUTOMATE_FLOW_STATUS = {
    ...
    "issue": "Validated: the AtoB tracking URL resolves through the two-hop redirect chain and returns the final CSV payload.",
    "resolution": "Compose - CSV Text decodes HTTP - Follow Redirect 2, then Run script populates AtoB-Parser.xlsx.",
    "fixed_at": "2026-05-21T17:15:38-05:00",
    "status": "validated_success",
    "validated_at": "2026-05-21T23:45:43Z",
    "latest_run_id": "08584221997564109507812261464CU09",
    "latest_run_at": "2026-05-21T23:45:29Z",
    "latest_run_tracking_id": "08584222024119360081644246379CU31",
    "validation_path": "HTTP - Download CSV -> HTTP - Follow Redirect -> HTTP - Follow Redirect 2 -> Compose - CSV Text -> Run script",
    "next_step": "Monitor the next AtoB email run; no operator action is required while both Outlook and Excel Online connections remain connected.",
}
