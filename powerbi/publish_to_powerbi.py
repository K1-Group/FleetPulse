...
TABLE_ENDPOINTS = {
    ...
    "OperatingCostSummary": "/api/powerbi/operating-cost/summary?days=180",
    "OperatingCostWeekly": "/api/powerbi/operating-cost/weekly?days=180",
}
...
TABLE_SCHEMAS: dict[str, list[dict[str, str]]] = {
    ...
    "OperatingCostSummary": [
        ...
        {"name": "period_end", "dataType": "String"},
        {"name": "generated_at", "dataType": "DateTime"},
        {"name": "complete_cost_available", "dataType": "bool"},
        {"name": "unresolved_sources", "dataType": "String"},
        {"name": "miles", "dataType": "Double"},
        {"name": "drive_hours", "dataType": "Double"},
        {"name": "idle_hours", "dataType": "Double"},
        {"name": "operating_hours", "dataType": "Double"},
        {"name": "trips", "dataType": "Int64"},
        {"name": "fuel_cost", "dataType": "Double"},
        {"name": "driver_pay", "dataType": "Double"},
        {"name": "insurance_cost", "dataType": "Double"},
        {"name": "other_expense_cost", "dataType": "Double"},
        {"name": "known_operating_cost", "dataType": "Double"},
        {"name": "true_operating_cost", "dataType": "Double"},
        {"name": "known_cost_per_mile", "dataType": "Double"},
        {"name": "true_cost_per_mile", "dataType": "Double"},
        {"name": "known_cost_per_drive_hour", "dataType": "Double"},
        {"name": "true_cost_per_drive_hour", "dataType": "Double"},
        {"name": "known_cost_per_operating_hour", "dataType": "Double"},
        {"name": "true_cost_per_operating_hour", "dataType": "Double"},
        {"name": "connection_name", "dataType": "String"},
        {"name": "exported_at", "dataType": "DateTime"},
        {"name": "source_system", "dataType": "String"},
        {"name": "source_authority", "dataType": "String"},
    ...
    "OperatingCostWeekly": [
        ...
        {"name": "complete_cost_available", "dataType": "bool"},
        {"name": "unresolved_sources", "dataType": "String"},
        {"name": "week_start", "dataType": "String"},
        {"name": "week_end", "dataType": "String"},
        {"name": "miles", "dataType": "Double"},
        {"name": "drive_hours", "dataType": "Double"},
        {"name": "idle_hours", "dataType": "Double"},
        {"name": "operating_hours", "dataType": "Double"},
